...
for n in range(n_iterations):
    ...
    for m in range(n_constraints): # constraints
        ...
        # Fit models
        mae[n, m, 0, 0], mae[n, m, 0, 1], times[n, m, 0, 0], times[n, m, 0, 1], corrs[n, m, 0, 0], corrs[n, m, 0, 1] = fit_model(linreg, X_train, y_train, X_test, y_test)
        mae[n, m, 1, 0], mae[n, m, 1, 1], times[n, m, 1, 0], times[n, m, 1, 1], corrs[n, m, 1, 0], corrs[n, m, 1, 1] = fit_model(ridge, X_train, y_train, X_test, y_test)
        mae[n, m, 2, 0], mae[n, m, 2, 1], times[n, m, 2, 0], times[n, m, 2, 1], corrs[n, m, 2, 0], corrs[n, m, 2, 1] = fit_model(kr, X_train, y_train, X_test, y_test)
